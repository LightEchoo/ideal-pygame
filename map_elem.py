...
class block(pygame.sprite.Sprite):
    def __init__(self, x, y) -> None:
        super().__init__()
        self.image = pygame.image.load('/Users/ruochenqi/Documents/GitHub/ideal-pygame/images/floor_block.png')
        self.rect = self.image.get_rect(topleft=(x,y))

class block_floor(pygame.sprite.Sprite):
    def __init__(self, x, y, num_stacks):
        super().__init__()
        original_image = pygame.image.load('/Users/ruochenqi/Documents/GitHub/ideal-pygame/images/floor_block.png')
